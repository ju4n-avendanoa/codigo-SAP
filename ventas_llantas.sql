...
FROM "BD_PARTEQUIPOS_PRO".OINV T0
...
INNER JOIN "BD_PARTEQUIPOS_PRO".OITM T6 ON T1."ItemCode" = T6."ItemCode"

WHERE T0."DocDate" >= '2025-01-01' AND T0."DocDate" < '2026-01-01' AND (T4."ItmsGrpCod" = 117 OR T4."ItmsGrpCod" = 105)
...
FROM "BD_PARTEQUIPOS_PRO".ORIN T0 
...
WHERE T0."DocDate" >= '2025-01-01' AND T0."DocDate" < '2026-01-01' AND T0."DocType" = 'I' AND T1."BaseType" <> 16 AND (T4."ItmsGrpCod" = 117 OR T4."ItmsGrpCod" = 105)